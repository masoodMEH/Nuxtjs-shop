...
!(function (t, e) {
          ...
          },
          {
            ...
            value: function (t) {
              if (t) {
                ...
                var r,
                  l = t.$el.dataset.index;
                (l && parseInt(l, 10) === t.index) ||
                ...
                i ||
                  ...
                  ("html5video" !== i && "video" !== i) ||
                    ...
                    t._width && t._height
                      ...
                      : (t.ratio = t.ratio || t.video.ratio || Y.video.ratio));
              }
            },
          },
          {
          ...
          [
            {
              ...
              value: function () {
                ...
                if (a.slug) s = a.slug;
                  ...
                  var r = a.$trigger && a.$trigger.dataset,
                    l = e.option("slug") || (r && r.fancybox);
                  l &&
                    l.length &&
                    "true" !== l &&
                    (s = l + (i.slides.length > 1 ? "-" + (a.index + 1) : ""));
                }
                n && (this.origHash = o !== s ? this.origHash : ""),
                  s &&
                    o !== s &&
            ...
            },
            {
              ...
              value: function () {
                ...
                if (o) {
                  if (i) {
                    var a = o.Carousel;
                    if (i === o.option("slug")) return a.slideTo(n - 1);
                    var s,
                      r = y(a.slides);
                    try {
                      for (r.s(); !(s = r.n()).done; ) {
        ...
        fullscreen: {
          ...
          click: function (t) {
            t.preventDefault(),
              K.element()
                ? K.deactivate()
                : K.activate(this.fancybox.$container);
          },
        },
        slideshow: {
          type: "button",
              ...
              value: function (t) {
                if (!t.defaultPrevented) {
                  ...
                  if (e.matches("[data-fancybox-close]"))
                    return t.preventDefault(), void i.close(!1);
                ...
                if (
                  ...
                  for (
                    var e,
                      ...
                      s = [],
                      r = 0,
                      l = Array.from(n.querySelectorAll(H));
                    r < l.length;
                    r++
                  ) {
                    var c = l[r],
                  ...
                  t
                    ...
                    ? W(e)
                    : s.indexOf(document.activeElement) < 0 && W(n),
            ...
            },
            {
              ...
              value: function (t) {
                var e =
                  ...
                  s = e.target || null,
                  r =
                    void 0 !== (e = x({}, e, i.openers.get(t))).groupAll &&
                    e.groupAll,
  ...
  for (
    var st = 0, rt = Object.entries(at.Plugins || {});
    st < rt.length;
    st++
  ) {
    var lt = v(rt[st], 2);
